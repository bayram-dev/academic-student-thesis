...
\begin{acronym}
        ...
        \acro{tcp}[TCP]{ --- Transmission Control Protocol --- протокол управления передачей}
        \acro{udp}[UDP]{ --- User Datagram Protocol --- протокол пользовательских датаграмм}
        \acro{rtt}[RTT]{ --- Round-trip time (delay) --- время приема-передачи}
        \acro{qos}[QoS]{ --- Quality of service --- качество обслуживания}
\end{acronym}
